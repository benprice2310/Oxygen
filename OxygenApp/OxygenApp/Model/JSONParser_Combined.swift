...
class JSONParser_Combined {
    ...
    static func extractJobsAndCourses(from jsonData: Data) -> (jobs: [JobListing], courses: [Course])? {
        if let root = JSONParser_Combined.parse(data: jsonData) {
